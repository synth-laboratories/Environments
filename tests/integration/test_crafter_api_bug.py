...
class TestCrafterApiBugFix:
    ...
    @pytest.mark.asyncio
    async def test_crafter_action_step_bug_fix(
        ...
        async with httpx.AsyncClient() as client:
            ...
            expected_fields = [
                "inventory", "achievements_status", "player_position", 
                "player_direction", "semantic_map", "world_material_map"
            ]
    ...
    async def test_crafter_basic_functionality_working(self):
        ...
        from horizons.environments.examples.crafter_classic.taskset import CrafterTaskInstance, CrafterTaskInstanceMetadata
        from horizons.environments.tasks.core import Impetus, Intent
        from horizons.environments.environment.tools import EnvToolCall
