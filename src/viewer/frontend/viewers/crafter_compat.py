...
def CrafterViewerCompat(trace_data: Dict[str, Any]) -> rx.Component:
    ...
    return rx.vstack(
        ...
        rx.hstack(
            ...
            rx.text(f"Difficulty: {difficulty}", 
        ...
        rx.vstack(
            ...
            *turn_components,
            rx.cond(
                num_turns > 5,
                rx.text(f"... and {num_turns - 5} more turns", 
                       color="gray.500", 
                       font_style="italic"),
            ),
            width="100%",
...
def render_crafter_turn_compat(partition: Dict[str, Any], turn_idx: int) -> rx.Component:
    ...
    return rx.vstack(
        ...
        rx.cond(
            ...
            rx.hstack(
                ...
                rx.text(f"❤️ Health: {stats.get('health', 0)}",
                       padding="0.25rem 0.5rem",
                       bg="red.100",
                       color="red.800",
                       border_radius="4px",
                       font_size="0.9rem"),
                rx.text(f"🍖 Food: {stats.get('food', 0)}",
                       padding="0.25rem 0.5rem",
                       bg="orange.100",
                       color="orange.800",
                       border_radius="4px",
                       font_size="0.9rem"),
                rx.text(f"💧 Drink: {stats.get('drink', 0)}",
                       padding="0.25rem 0.5rem",
                       bg="blue.100",
                       color="blue.800",
                       border_radius="4px",
