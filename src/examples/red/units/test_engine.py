...
from src.examples.red.engine import PokemonRedEngine, BUTTON_MAP, PokemonRedEngineSnapshot
...
class TestPokemonRedEngine:
    ...
    async def test_extract_current_state_real(self, task_instance):
        ...
        expected_keys = ["map_id", "player_x", "player_y", "badges", "party_hp_current", 
                        "party_hp_max", "party_level", "party_xp", "in_battle", "battle_outcome",
                        "inventory_count", "menu_state", "warp_flag"]
