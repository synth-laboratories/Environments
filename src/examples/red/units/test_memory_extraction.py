import pytest
from src.examples.red.engine_helpers.state_extraction import (
    extract_game_state,
    get_badge_count,
    format_position,
    format_hp_status,
...
class TestMemoryExtraction:
    ...
    def test_memory_addresses_valid(self):
        ...
        addresses = [
            BADGE_FLAGS, MAP_ID, PLAYER_X, PLAYER_Y,
            IN_BATTLE_FLAG, BATTLE_OUTCOME, PARTY_LEVELS,
            PARTY_HP_CURRENT, PARTY_HP_MAX, PARTY_XP,
            INVENTORY_COUNT, INVENTORY_START, MENU_STATE, WARP_FLAG
        ]
