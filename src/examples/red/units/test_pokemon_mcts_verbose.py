...
async def verbose_mcts_test():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        from src.examples.red.units.test_tree import pokemon_red_mcts_plan
        ...
        for i, action in enumerate(plan):
            ...
            print(f"  Pos: ({pub.player_x},{pub.player_y}) → ({new_pub.player_x},{new_pub.player_y})")
        ...
        # Final assessment
        from src.examples.red.units.test_tree import heuristic_score
