...
from src.examples.red.taskset import TASK, INSTANCE, PokemonRedTaskInstance
...
class TestPokemonRedTaskset:
    ...
    def test_pokemon_red_task_instance_type(self):
        ...
        custom_instance = PokemonRedTaskInstance(
            ...
            intent=Intent(rubric="Test goal: achieve something", gold_trajectories=None, gold_state_diff={}),
