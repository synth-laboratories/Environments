...
class PokemonRedTaskInstance(TaskInstance):
    ...
    async def serialize(self) -> dict:
        ...
        return {
            ...
            "initial_engine_snapshot": str(self.initial_engine_snapshot) if self.initial_engine_snapshot else None
        }
...
INSTANCE = PokemonRedTaskInstance(
    ...
    impetus=Impetus(instructions="Navigate to Pewter Gym and defeat Brock to earn the Boulder Badge. Use strategic Pokemon battles and item management."),
    intent=Intent(
