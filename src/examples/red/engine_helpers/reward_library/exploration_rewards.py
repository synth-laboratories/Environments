...
class BuildingEntryReward(RewardComponent):
    ...
    async def score(self, state: Dict[str, Any], action: Dict[str, Any]) -> float:
        ...
        if (current_map in self.building_maps and 
            current_map not in self.buildings_entered and
...
class HiddenAreaDiscoveryReward(RewardComponent):
    ...
    async def score(self, state: Dict[str, Any], action: Dict[str, Any]) -> float:
        ...
        if (current_map in self.hidden_areas and 
            current_map not in self.hidden_areas_found):
...
class FirstItemOfTypeReward(RewardComponent):
    ...
    def __init__(self):
        ...
        self.item_types = {
            1: "pokeball", 2: "pokeball", 3: "pokeball",
            10: "potion", 11: "potion", 12: "potion",
            20: "tm", 21: "tm", 22: "tm",
            # Add more mappings
        }
