...
from src.examples.verilog.environment import (
    VerilogEnvironment,
...
from src.examples.verilog.engine import VerilogEngine, VerilogPublicState, VerilogPrivateState
from src.examples.verilog.taskset import VerilogTaskInstance, VerilogTaskInstanceMetadata
...
class TestVerilogTools:
    ...
    async def test_compile_tool(self, mock_engine):
        ...
        call = EnvToolCall(
            tool="compile",
            args={"sources": ["test.v"], "testbench": "test_tb.v"}
        )
