...
class NeuralMMOActionInput(BaseModel):
    action: Dict[str, Any] = Field(..., description="NMMO action dictionary with keys like 'Move', 'Attack', etc.")
...
class NeuralMMOEnvironment(StatefulEnvironment, ReproducibleEnvironment[NeuralMMOEngine]):
    """
    ...
    async def _to_observation(
        ...
        return await (obs_cb or NeuralMMOObservationCallable(self.engine)).get_observation(pub, priv)
