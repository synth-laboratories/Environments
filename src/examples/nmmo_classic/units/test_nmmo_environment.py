...
from src.examples.nmmo_classic.environment import NeuralMMOEnvironment
from src.examples.nmmo_classic.taskset import NeuralMMOTaskInstance, NeuralMMOTaskInstanceMetadata
...
if __name__ == "__main__":
    ...
    async def manual_test():
        ...
        print(f"Tick: {obs['tick']}, Position: {obs['position']}, Health: {obs['health']}")
