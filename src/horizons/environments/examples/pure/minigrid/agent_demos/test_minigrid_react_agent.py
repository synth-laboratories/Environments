...
from horizons.zyk import LM
from horizons.zyk.lms.tools.base import BaseTool
...
async def evaluate_minigrid_batch() -> float:
    ...
    from horizons.environments.examples.minigrid.taskset import create_minigrid_task_from_seed
