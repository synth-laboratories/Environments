...
class TicTacToeEnvironment(StatefulEnvironment, ReproducibleEnvironment[TicTacToeEngine]):
    def __init__(self, task_instance: TaskInstance, 
        ...
        self.custom_checkpoint_observation_callable = custom_ckpt_obs or SynthTicTacToeCheckpointObservationCallable()
        ...
        if isinstance(tool_calls, EnvToolCall):
            ...
            if "tool" in tool_calls:
                ...
                validated_call = EnvToolCall(
                    ...
                    args=tool_calls.get("parameters", {})
                )
    ...
    async def _to_observation(self, priv: TicTacToePrivateState, pub: TicTacToePublicState, 
                             obs_cb: Optional[GetObservationCallable], extra_obs: Optional[Dict] = None) -> InternalObservation:
    ...
    @classmethod
    async def _deserialize_engine(cls, snapshot: TicTacToeEngineSnapshot, task_instance: TaskInstance) -> "TicTacToeEnvironment":
