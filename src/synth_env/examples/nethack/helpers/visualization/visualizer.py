...
class NetHackVisualizer:
    ...
    def ascii_to_image(self, ascii_map: str, highlight_pos: Optional[Tuple[int, int]] = None) -> np.ndarray:
    ...
    def _simple_ascii_to_image(self, ascii_map: str, highlight_pos: Optional[Tuple[int, int]] = None) -> np.ndarray:
    ...
    def create_frame_image(self, observation: Dict[str, Any], 
    ...
    def _create_terminal_view(self, observation: Dict[str, Any], 
                             width: int = 80, height: int = 24) -> np.ndarray:
        ...
        draw.line([(0, 21 * self.cell_size), (img_width, 21 * self.cell_size)], 
                 fill='#666666', width=1)
    ...
    def create_trajectory_video(self, frames: List[Dict[str, Any]], 
                               output_path: str, fps: int = 4,
    ...
    def plot_trajectory_stats(self, frames: List[Dict[str, Any]], 
    ...
    def plot_action_distribution(self, frames: List[Dict[str, Any]], 
                                output_path: Optional[str] = None):
