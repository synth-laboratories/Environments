...
from synth_env.examples.nethack.environment import NetHackEnvironment, NetHackInteractTool
from synth_env.examples.nethack.taskset import NetHackTaskInstanceMetadata, NetHackTaskInstance
...
class TestNetHackInteractTool:
    ...
    def mock_engine(self, mock_task_instance):
        ...
        from synth_env.examples.nethack.engine import NetHackEngine
