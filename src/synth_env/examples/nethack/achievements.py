    ...
    def update(self, dungeon_name, experience_level):
        ...
        if dungeon_name in self.achievements["dungeons"]:
            ...
            if new_progression > self.dungeon_progression:
                ...
                achievements_unlocked.append(f"dungeon {dungeon_name} ({old_score} -> {new_progression} points)")
        ...
        if exp_key in self.achievements["experience_levels"]:
            ...
            if new_progression > self.experience_progression:
                ...
                achievements_unlocked.append(f"experience {exp_key} ({old_score} -> {new_progression} points)")
...
class NetHackAchievements:
    ...
    def update_from_observation(self, obs: Dict[str, Any], prev_obs: Optional[Dict[str, Any]] = None) -> Dict[str, bool]:
...
def calculate_balrog_reward(obs: Dict[str, Any], prev_obs: Optional[Dict[str, Any]] = None) -> float:
    """
