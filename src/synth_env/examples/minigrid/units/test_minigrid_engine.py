...
async def test_reward_components():
    ...
    from synth_env.examples.minigrid.engine import MiniGridPublicState
...
async def test_different_environments():
    ...
    from synth_env.examples.minigrid.taskset import MiniGridTaskInstance, MiniGridTaskInstanceMetadata
    from synth_env.tasks.api import Impetus, Intent
