...
from synth_env.examples.minigrid.environment import MiniGridEnvironment, MiniGridInteractTool
...
async def test_interact_tool():
    ...
    from synth_env.examples.minigrid.engine import MiniGridEngine
