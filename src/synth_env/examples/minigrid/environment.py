...
from synth_env.examples.minigrid.engine import (
    MiniGridEngine,
    MiniGridPublicState,
...
class MiniGridEnvironment(StatefulEnvironment, ReproducibleEnvironment[MiniGridEngine]):
    ...
    def __init__(
        ...
        self.custom_checkpoint_observation_callable = custom_ckpt_obs or MiniGridCheckpointObservationCallable()
    ...
    async def step(self, tool_calls: Union[List[Dict[str, Any]], Dict[str, Any]]) -> InternalObservation:
    ...
    def validate_tool_calls(self, tool_calls: Union[List[Dict[str, Any]], Dict[str, Any], EnvToolCall]) -> EnvToolCall:
    ...
    async def _deserialize_engine(cls, data: Dict[str, Any]) -> MiniGridEngine:
        ...
        from synth_env.examples.minigrid.engine import MiniGridEngineSnapshot
